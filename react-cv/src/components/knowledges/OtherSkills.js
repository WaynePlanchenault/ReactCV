    ...
    return (
            <div className="otherSkills">
                ...
                <div className="list">
                    ...
                    <ul>
                        <li><i className="fas fa-check-square"></i> UI/UX</li>
                        <li><i className="fas fa-check-square"></i> Gestion BDD</li>
                        <li><i className="fas fa-check-square"></i> Shopify</li>
                        <li><i className="fas fa-check-square"></i> Wordpress</li>
                    </ul>
                </div>
            </div>
    );
